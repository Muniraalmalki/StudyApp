...
class KotlinActivity : AppCompatActivity() {
    ...
    private lateinit var kotlinRecyclerView: RecyclerView
    ...
    private fun setTopics(): ArrayList<Topic> {
        return arrayListOf(
            Topic(
                "Print", "Print to console in Kotlin", "Kotlin has 2 print methods:\n\n" +
            ...
            Topic(
                ...
                "In Kotlin, there is 2 types of variables:\n" +
            ...
            Topic(
                "Data types",
                "Useful data types",
                "Kotlin has various data types, including but not limited to:\n\n" +
                        "- Int\n" +
                        "- Float\n" +
                        "- Boolean\n" +
                        "- String\n" +
            ...
            Topic(
                ...
                "Concatenation: you can simply concat multiple strings by using +. eg.: “Hello ” + “World”.\n\n" +
            ...
            Topic(
                "Loops",
                "for & while loops",
                "- for loop: eg. for (i in message), for (i in 0…10). in keyword is doing magic!\n\n" +
                        "- while loop: don’t forget to control it! you don’t want to be stuck in an infinite loop!"
            ),

            Topic(
                "Try/Catch", "An example", "try {\n\n" +
