...
class AndroidActivity : AppCompatActivity() {
    ...
    private lateinit var androidRecycleView: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        androidRecycleView = findViewById(R.id.rvAndroid)
        androidRecycleView.adapter = RecyclerViewAdapter(setTopics())
        androidRecycleView.layoutManager =  LinearLayoutManager(this)
